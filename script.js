...
var quizQuestions = [{
    ...
    correctAnswer: "d"},
  {
    ...
    correctAnswer: "d"},
   {
    ...
    correctAnswer: "c"},
    {
    question: "What are variables listed outside of function called?",
    choiceA: "Global Variables",
    choiceB: "Master Variables",
    choiceC: "Nested Variables",
    choiceD: "Local Variables",
    correctAnswer: "a"},
    {
    question: "Select the answer with strictly HTML elements...",
    choiceA: "Handles, Brakes, and Motors",
    choiceB: "Stems, Branches, and Roots",
